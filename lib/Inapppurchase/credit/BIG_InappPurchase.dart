...
class BIG_Inapppurchase extends StatefulWidget {
  final bool item;
  final bool? home;
  final bool? credit;
  const BIG_Inapppurchase({super.key, required this.item, this.credit, this.home});

  @override
  State<BIG_Inapppurchase> createState() => _BIG_InapppurchaseState();
}

class _BIG_InapppurchaseState extends State<BIG_Inapppurchase> {
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: AssetImage(
                                    'assets/sc_24/fast processing.png'),
                                fit: BoxFit.contain,
                              ),
                            ),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image:
                                    AssetImage('assets/sc_24/unlock pro.png'),
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
                ...
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Align(
                        alignment:
                            Alignment.topCenter, // Center it horizontally
                        child: Container(
                          height: 82.h,
                          width: 269.w,
                          decoration: BoxDecoration(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Terms of use",
                        style: TextStyle(
                            color: Color(0XFF464646), fontSize: 45.sp),
                      ),
                      Container(
                        height: 40.h,
                        width: 3.w,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          if (widget.home == true) {
                            ...
                            // AdsLoadUtil.loadAndShow(adId: AdsVariable.big_appopen, onDismissed: (){Get.back();});
                          } else {
                            AdsLoadUtil.showInterstitial(onDismissed: () {
                              Get.to(() => BIG_Homepage());
                            });
                            // AdsLoadUtil.loadAndShow(adId: AdsVariable.big_appopen, onDismissed: (){Get.to(() => Homepage());});
                          }
                        },
                        child: close == true
                            ? Align(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "Terms of use",
                      style:
                          TextStyle(color: Color(0XFF464646), fontSize: 45.sp),
                    ),
                    Container(
                      height: 40.h,
                      width: 3.w,
