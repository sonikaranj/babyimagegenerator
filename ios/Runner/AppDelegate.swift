...
//         FaceBook Integration with Firebase Config
        ...
        batteryChannel.setMethodCallHandler({
            ...
            btnBgColor = myresult?["btnBgColor"] as? String
...
//         let listTileBig = BigNativeAdFactory()
//         FLTGoogleMobileAdsPlugin.registerNativeAdFactory(
//             self, factoryId: "bigNativeAds", nativeAdFactory: listTileBig)
...
//     method for notification :
    func sendNotification() {
        ...
        content.title = "AI Logo Maker"
        content.body = "Create Your own Style LOGO"
